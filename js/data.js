...
const CITIES = {
  tokyo: { id:"tokyo", name:"Tokyo", jp:"東京", lat:35.6812, lng:139.7671,
    stays:[
      { id:"tokyo-1", label:"Séjour 1 — arrivée", from:"8 nov", to:"12 nov", nights:"4 nuits",
        hotel:{ name:"Hôtel Kumo", area:"Près de Tokyo Station", address:"Adresse à définir",
          checkIn:"8 nov · après l’arrivée", checkOut:"12 nov · matin",
          status:"placeholder", payment:"Pas encore réservé", price:"—",
          notes:["Type de chambre à définir","Petit-déjeuner à définir"],
      ...
      { id:"tokyo-2", label:"Séjour 2 — retour", from:"27 nov", to:"29 nov", nights:"2 nuits",
        hotel:{ name:"Hôtel Hikari", area:"Ikebukuro / nord de Tokyo", address:"Adresse à définir",
          checkIn:"27 nov · après le shinkansen", checkOut:"29 nov · tôt pour l’aéroport",
          status:"placeholder", payment:"Pas encore réservé", price:"—",
          notes:["Proche des derniers shopping / Pokemon","Départ tôt pour le vol CDG"],
  ...
  fuji: { id:"fuji", name:"Fujikawaguchiko", jp:"河口湖", lat:35.5006, lng:138.7639,
    stays:[{ id:"fuji-1", label:"Séjour lac", from:"12 nov", to:"14 nov", nights:"2 nuits",
      hotel:{ name:"Ryokan Fuji-view", area:"Kawaguchiko", address:"À définir",
        checkIn:"12 nov", checkOut:"14 nov", status:"placeholder", payment:"Pas encore réservé", price:"—",
        notes:["Vue lac ou Fuji si possible"], desc:"Base calme au bord du lac, avec vue montagne." } }] },
  kanazawa: { id:"kanazawa", name:"Kanazawa", jp:"金沢", lat:36.5611, lng:136.6565,
    stays:[{ id:"kana-1", label:"Séjour Kanazawa", from:"14 nov", to:"17 nov", nights:"3 nuits",
      hotel:{ name:"Hôtel Kaga", area:"Centre de Kanazawa", address:"À définir",
        checkIn:"14 nov", checkOut:"17 nov", status:"placeholder", payment:"Pas encore réservé", price:"—",
        notes:[], desc:"Base pour Kenroku-en, le château et les quartiers de thé." } }] },
  ...
  takayama: { id:"takayama", name:"Takayama", jp:"高山", lat:36.1461, lng:137.2522,
    stays:[{ id:"taka-1", label:"Séjour Takayama", from:"17 nov", to:"18 nov", nights:"1 nuit",
      hotel:{ name:"Ryokan Hida", area:"Vieille ville", address:"À définir",
        checkIn:"17 nov", checkOut:"18 nov", status:"placeholder", payment:"Pas encore réservé", price:"—",
        notes:[], desc:"Une nuit dans les rues historiques avant Kyoto." } }] },
  kyoto: { id:"kyoto", name:"Kyoto", jp:"京都", lat:35.0116, lng:135.7681,
    stays:[{ id:"kyo-1", label:"Séjour Kyoto", from:"18 nov", to:"22 nov", nights:"4 nuits",
      hotel:{ name:"Hôtel Kyo", area:"Centre de Kyoto", address:"À définir",
        checkIn:"18 nov", checkOut:"22 nov", status:"placeholder", payment:"Pas encore réservé", price:"—",
        notes:[], desc:"Quatre nuits pour temples, Arashiyama et Fushimi." } }] },
  nara: { id:"nara", name:"Nara", jp:"奈良", lat:34.6851, lng:135.8050,
    stays:[{ id:"nara-1", label:"Séjour Nara", from:"22 nov", to:"23 nov", nights:"1 nuit",
      hotel:{ name:"Hôtel Shika", area:"Près du parc de Nara", address:"À définir",
        checkIn:"22 nov", checkOut:"23 nov", status:"placeholder", payment:"Pas encore réservé", price:"—",
        notes:[], desc:"Court séjour pour le parc et les temples." } }] },
  osaka: { id:"osaka", name:"Osaka", jp:"大阪", lat:34.6937, lng:135.5023,
    stays:[{ id:"osa-1", label:"Séjour Osaka", from:"23 nov", to:"27 nov", nights:"4 nuits",
      hotel:{ name:"Hôtel Naniwa", area:"Namba", address:"À définir",
        checkIn:"23 nov", checkOut:"27 nov", status:"placeholder", payment:"Pas encore réservé", price:"—",
        notes:["Pratique pour Dotonbori / USJ"], desc:"Base food & nightlife à Namba." } }] }
};
...
const DAYS = [
  ...
  { n:5, date:"12 nov 2026", dow:"Jeudi", city:"fuji",
    moves:[{when:"~7:00–9:00", title:"Tokyo → Fujikawaguchiko", dummy:"Train (à réserver)", mode:"Train", leg:"tokyo-fuji"}],
    ideas:[
  ...
  { n:7, date:"14 nov 2026", dow:"Samedi", city:"kanazawa",
    moves:[{when:"~10:00–15:10", title:"Fujikawaguchiko → Kanazawa", dummy:"Train (à réserver)", mode:"Train", leg:"fuji-kana"}],
    ideas:[
  ...
  { n:10, date:"17 nov 2026", dow:"Mardi", city:"shirakawa", extraCity:"takayama",
    moves:[{when:"~8:50–10:05", title:"Kanazawa → Shirakawa-go", dummy:"Bus (à réserver)", mode:"Bus", leg:"kana-shira"},
           {when:"~14:00–14:50", title:"Shirakawa-go → Takayama", dummy:"Bus (à réserver)", mode:"Bus", leg:"shira-taka"}],
    ideas:[
  ...
  { n:11, date:"18 nov 2026", dow:"Mercredi", city:"takayama", extraCity:"kyoto",
    ...
    moves:[{when:"~13:30–16:30", title:"Takayama → Kyoto", dummy:"Train (à réserver)", mode:"Train", leg:"taka-kyo"}],
    ideasAfter:[
  ...
  { n:15, date:"22 nov 2026", dow:"Dimanche", city:"kyoto", extraCity:"nara",
    ...
    moves:[{when:"~16:15–17:15", title:"Kyoto → Nara", dummy:"Train (à réserver)", mode:"Train", leg:"kyo-nara"}] },
  { n:16, date:"23 nov 2026", dow:"Lundi", city:"nara", extraCity:"osaka",
    ...
    moves:[{when:"~16:15–17:00", title:"Nara → Osaka", dummy:"Train (à réserver)", mode:"Train", leg:"nara-osa"}],
    ideasAfter:[
  ...
  { n:20, date:"27 nov 2026", dow:"Vendredi", city:"tokyo", extraCity:"osaka",
    ...
    moves:[{when:"~11:30–14:00", title:"Osaka → Tokyo", dummy:"Shinkansen (à réserver)", mode:"Shinkansen", leg:"osa-tokyo"}] },
...
const LEGS = [
  ...
  { id:"tokyo-fuji", title:"Tokyo → Fujikawaguchiko", subtitle:"12 nov · Jour 5", mode:"Train",
    ...
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.tokyo, to:CITIES.fuji, via:[{lat:35.61,lng:139.35},{lat:35.55,lng:138.95}],
    details:["Changement de ville le matin."], tips:"Partir tôt pour le lac." },
  { id:"fuji-kana", title:"Fujikawaguchiko → Kanazawa", subtitle:"14 nov · Jour 7", mode:"Train",
    depart:"~10:00", arrive:"~15:10", duration:"~5 h",
    operator:"JR (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.fuji, to:CITIES.kanazawa, via:[{lat:35.85,lng:138.4},{lat:36.4,lng:137.3}],
    details:["Journée de transit plus longue."], tips:"Manger dans le train." },
  { id:"kana-shira", title:"Kanazawa → Shirakawa-go", subtitle:"17 nov · Jour 10", mode:"Bus",
    depart:"~8:50", arrive:"~10:05", duration:"~1 h 15",
    operator:"Nohi / bus local (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.kanazawa, to:CITIES.shirakawa, via:[{lat:36.4,lng:136.78}],
    details:["Visite à la journée."], tips:"Enchaîner avec le bus de l’après-midi." },
  { id:"shira-taka", title:"Shirakawa-go → Takayama", subtitle:"17 nov · Jour 10", mode:"Bus",
    depart:"~14:00", arrive:"~14:50", duration:"~50 min",
    operator:"Bus Nohi (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.shirakawa, to:CITIES.takayama, via:[{lat:36.2,lng:137.05}],
    details:["Deuxième changement de la journée."], tips:"Vieille ville ensuite." },
  { id:"taka-kyo", title:"Takayama → Kyoto", subtitle:"18 nov · Jour 11", mode:"Train",
    depart:"~13:30", arrive:"~16:30", duration:"~3 h",
    operator:"JR (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.takayama, to:CITIES.kyoto, via:[{lat:35.6,lng:136.7},{lat:35.2,lng:136.0}],
    details:["Après-midi vers Kyoto."], tips:"L’heure de départ est le vrai rendez-vous." },
  { id:"kyo-nara", title:"Kyoto → Nara", subtitle:"22 nov · Jour 15", mode:"Train",
    depart:"~16:15", arrive:"~17:15", duration:"~50 min",
    operator:"Kintetsu / JR (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.kyoto, to:CITIES.nara, via:[{lat:34.85,lng:135.78}],
    details:["Soirée à Nara."], tips:"Le Kintetsu est près du parc." },
  { id:"nara-osa", title:"Nara → Osaka", subtitle:"23 nov · Jour 16", mode:"Train",
    depart:"~16:15", arrive:"~17:00", duration:"~40 min",
    operator:"Kintetsu / JR (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.nara, to:CITIES.osaka, via:[{lat:34.68,lng:135.62}],
    details:["Soirée à Osaka."], tips:"Namba / Dotonbori." },
  { id:"osa-tokyo", title:"Osaka → Tokyo", subtitle:"27 nov · Jour 20", mode:"Shinkansen",
    depart:"~11:30", arrive:"~14:00", duration:"~2 h 30",
    operator:"JR Tokaido Shinkansen (à définir)", seat:"—", ref:"—",
    status:"placeholder", payment:"Pas encore réservé", price:"—",
    from:CITIES.osaka, to:CITIES.tokyo,
